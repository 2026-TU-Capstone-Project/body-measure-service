...
def get_measurement_attention_mlp(batch_size=4, num_input_features=20, list_attention_shapes=[32,16,8]) :
    ...
    out_x1 = tf.keras.layers.Reshape((list_attention_shapes[0],list_attention_shapes[0],1))(x1)
    out_x2 = tf.keras.layers.Reshape((list_attention_shapes[1],list_attention_shapes[1],1))(x2)
    out_x3 = tf.keras.layers.Reshape((list_attention_shapes[2],list_attention_shapes[2],1))(x3)
